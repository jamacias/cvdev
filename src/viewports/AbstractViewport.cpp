...
void AbstractViewport::setWindowSize(const Vector2i &size)
{
    windowSize_ = size;
}

void AbstractViewport::setRelativeViewport(const Range2D &relativeViewport)
{
...
void AbstractViewport::setViewport(const Range2Di &viewport)
{
...
Range2D AbstractViewport::calculateRelativeViewport(const Range2Di &absoluteViewport, const Vector2i &windowSize)
{
...
Range2Di AbstractViewport::calculateViewport(const Range2D &relativeViewport, const Vector2i &windowSize)
{
